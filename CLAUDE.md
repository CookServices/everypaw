...
*Dernière mise à jour : 2026-09-01 (Session 66 : backlog #9 clos, split de `order/page.tsx` et `settings/page.tsx` en composants de section ; #15 ouvert sur les étapes adresse et paiement non reparcourues)*
