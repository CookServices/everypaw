    ...
    <div style={{ minHeight: "100vh", background: "#F7F2EA", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "4rem 2rem 6rem" }}>
        ...
        {[
          ...
          ["9. Pages créées sans compte", "Une page mémorial peut être créée sans inscription. Elle contient le nom de l'animal, les dates et les souvenirs que vous écrivez, la photo que vous choisissez, et une empreinte à sens unique de votre adresse IP conservée pour limiter les abus. Elle n'est accessible que par son lien et n'est jamais indexée par les moteurs de recherche. Si personne ne la réclame en l'ajoutant à un compte, elle est supprimée automatiquement trente jours après sa création, photo comprise, ainsi que toute photo envoyée sans qu'une page ait jamais été créée. Une page réclamée rejoint le compte qui la réclame et suit la règle de conservation ci-dessus."],
        ].map(([title, body]) => (
