    ...
    return (
      <div style={{ minHeight: "100vh", background: "#F7F2EA", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", fontFamily: "'DM Sans', sans-serif" }}>
        <div style={{ textAlign: "center", maxWidth: 420 }}>
          ...
          <h2 style={{ fontFamily: "Georgia, serif", fontSize: "1.75rem", color: "#3D2B1F", marginBottom: ".75rem" }}>Check your inbox</h2>
    ...
    <div style={{ minHeight: "100vh", background: "#F7F2EA", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ marginTop: ".5rem", fontSize: ".9rem", color: "#7A5C44", fontWeight: 300 }}>Start your pet&#39;s story today</p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: "1.25rem", fontSize: ".85rem", color: "#7A5C44" }}>
          ...
          <Link href="/auth/login" style={{ color: "#C8813A", fontWeight: 500, textDecoration: "none" }}>Sign in →</Link>
        </p>
      </div>
    </div>
  );
