    ...
    <div style={{ minHeight: "100vh", background: "#F7F2EA", fontFamily: "'DM Sans', sans-serif" }}>
      <main style={{ maxWidth: 900, margin: "0 auto", padding: "3rem 1.5rem 4rem" }}>
        ...
        <p style={{ textAlign: "center", fontSize: ".72rem", color: "#9A8070", fontWeight: 300, marginTop: ".5rem", lineHeight: 1.5 }}>
          {isFR ? (
            <>En continuant, vous acceptez les <a href="/legal/terms" target="_blank" style={{ color: "#9A8070", textDecoration: "underline" }}>Conditions générales de vente</a>.</>
          ) : (
            <>By continuing, you agree to our <a href="/legal/terms" target="_blank" style={{ color: "#9A8070", textDecoration: "underline" }}>Terms of Service</a>.</>
          )}
        </p>
