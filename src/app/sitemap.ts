...
import { getPublishedPosts, getPublishedPostsFr } from "@/lib/blog";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogPostsFr: MetadataRoute.Sitemap = getPublishedPostsFr().map((post) => ({
  ...
  return [
    ...
    { url: `${base}/fr/memorial`,    lastModified: now, changeFrequency: "monthly", priority: 0.5 },
