      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
        ...
        {photos.length > 0 && (
          <div style={{ marginBottom: "2rem" }}>
            <div style={{ fontSize: ".7rem", fontWeight: 500, letterSpacing: ".12em", textTransform: "uppercase", color: "#C8813A", marginBottom: "1rem" }}>Moments</div>
        ...
        {stories && stories.length > 0 && (
          <div style={{ marginBottom: "2rem" }}>
            <div style={{ fontSize: ".7rem", fontWeight: 500, letterSpacing: ".12em", textTransform: "uppercase", color: "#C8813A", marginBottom: "1rem" }}>Stories</div>
        ...
        {entries && entries.length > 0 && (
          <div style={{ marginBottom: "2rem" }}>
            <div style={{ fontSize: ".7rem", fontWeight: 500, letterSpacing: ".12em", textTransform: "uppercase", color: "#C8813A", marginBottom: "1rem" }}>Recent moments</div>
        ...
        <div style={{ background: "#3D2B1F", borderRadius: 24, padding: "2rem", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "Georgia, serif", fontSize: "1.4rem", color: "#F7F2EA", marginBottom: ".75rem" }}>Create your pet&apos;s story</h2>
          <p style={{ fontSize: ".875rem", color: "rgba(247,242,234,.65)", fontWeight: 300, lineHeight: 1.6, marginBottom: "1.5rem" }}>
            Turn your pet&apos;s daily moments into AI-crafted narratives and a beautiful printed book.
          </p>
