...
import { baseLayout, hero, heading, paragraph, ctaButton, finePrint } from "@/lib/email-templates";
...
async function sendInviteEmail(
  ...
  const html = baseLayout(
    isFR
      ? hero({ illustration: "paw", emoji: "🐾", heading: `Vous avez été invité(e) à rejoindre le journal de ${safePet}` }) +
      ...
      : hero({ illustration: "paw", emoji: "🐾", heading: `You've been invited to join ${safePet}'s journal` }) +
