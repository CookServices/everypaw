        ...
        <div style={{ background: "#FDFAF5", borderRadius: 24, padding: isMobile ? "1.25rem 1rem" : "2rem", border: "1px solid rgba(61,43,31,.08)" }}>
          ...
          {step === "confirm" ? (
            ...
            <>
              ...
              <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: ".625rem", marginBottom: ".75rem" }}>

                {/* Digital */}
                <button
                  onClick={() => setSelectedPlan("digital")}
                  style={{ flex: 1, padding: "1rem", borderRadius: 14, border: `1.5px solid ${selectedPlan === "digital" ? "#C8813A" : "rgba(61,43,31,.15)"}`, background: selectedPlan === "digital" ? "rgba(200,129,58,.08)" : "transparent", cursor: "pointer", textAlign: "left", fontFamily: "inherit", transition: "all .12s" }}
                >
                ...
                <button
                  ...
                  style={{ flex: 1, padding: "1rem", borderRadius: 14, border: `1.5px solid ${selectedPlan === "print" ? "#C8813A" : "rgba(61,43,31,.15)"}`, background: selectedPlan === "print" ? "rgba(200,129,58,.08)" : "transparent", cursor: "pointer", textAlign: "left", fontFamily: "inherit", transition: "all .12s", position: "relative" }}
                >
